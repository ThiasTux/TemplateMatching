...
int32_t h_2d_cost_matrix[8][8] = {{0, 15, 31, 7, 7, 23, 23, 15},
                                {15, 0, 15, 23, 7, 7, 23, 31},
                                {31, 15, 0, 23, 23, 7, 7, 15},
                                {7, 23, 23, 0, 15, 31, 15, 7},
                                {7, 7, 23, 15, 0, 15, 31, 23},
                                {23, 7, 7, 31, 15, 0, 15, 23},
                                {23, 23, 7, 15, 31, 15, 0, 7},
                                {15, 31, 15, 7, 23, 23, 7, 0}};
