...
extern "C"{
    ...
    void wlcss_cuda(){
        ...
        wlcss_cuda_kernel<<<dim3(num_streams), num_templates>>>(d_mss, d_mss_offsets, d_ts, d_ss, d_tlen, d_toffsets, d_slen, d_soffsets, d_params, d_tmp_windows, d_tmp_windows_offsets, d_3d_cost_matrix);
