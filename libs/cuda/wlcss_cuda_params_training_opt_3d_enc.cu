...
extern "C"{
    void wlcss_cuda_init(int32_t *h_tmp_windows_offsets,
        ...
        gpuErrchk( cudaMalloc((void **) &d_3d_cost_matrix, 64 * sizeof(int32_t)) );
        gpuErrchk( cudaMemcpy(d_3d_cost_matrix, h_3d_cost_matrix, 64 * sizeof(int32_t), cudaMemcpyHostToDevice) );
