...
__global__ void wlcss_cuda_kernel(int32_t *d_mss, int32_t *d_mss_offsets, int32_t *d_ts, int32_t *d_ss, int32_t *d_tlen, int32_t *d_toffsets, int32_t *d_slen, int32_t *d_soffsets, int32_t *d_params){
    ...
    int32_t d_mss_offset = d_mss_offsets[template_idx*gridDim.x+stream_idx];
...
extern "C"{
    void wlcss_cuda_init(int32_t *h_mss_offsets, 
                         int32_t *h_ss, int32_t *h_slen, int32_t *h_soffsets, 
                         int num_ts, int num_ss, int num_ps, int h_ss_len, int h_mss_len){
    ...
    void wlcss_cuda(int32_t *h_mss, int32_t *h_ts, int32_t *h_tlen, int32_t *h_toffsets, int h_ts_len, int32_t *h_params){
        ...
        wlcss_cuda_kernel<<<dim3(num_streams), num_templates>>>(d_mss, d_mss_offsets, d_ts, d_ss, d_tlen, d_toffsets, d_slen, d_soffsets, d_params);
