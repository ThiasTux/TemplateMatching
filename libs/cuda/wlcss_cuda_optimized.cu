...
int32_t *d_mss, *d_mss_offset, *d_ts, *d_ss, *d_tlen, *d_toffsets, *d_slen, *d_soffsets, *d_params;
...
extern "C"{
    void wlcss_cuda_init(int32_t *h_mss, int32_t *h_mss_offsets, int32_t *h_ts, int32_t *h_ss, int32_t *h_tlen, int32_t *h_toffsets, int32_t *h_slen, int32_t *h_soffsets, int num_ts, int num_ss, int num_ps, int h_ts_len, int h_ss_len, int h_mss_len){
        ...
        gpuErrchk( cudaMalloc((void **) &d_mss_offset, num_streams*num_templates*num_params_sets * sizeof(int32_t)) );
        gpuErrchk( cudaMemcpy(d_mss_offset, h_mss_offsets, num_streams*num_templates*num_params_sets * sizeof(int32_t), cudaMemcpyHostToDevice) );
    ...
    void wlcss_cuda(int32_t *h_params, int32_t *h_mss){
        ...
        wlcss_cuda_kernel<<<dim3(num_templates, num_streams), num_params_sets>>>(d_mss, d_mss_offset, d_ts, d_ss, d_tlen, d_toffsets, d_slen, d_soffsets, d_params);
