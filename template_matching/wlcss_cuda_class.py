...
class WLCSSCudaParamsTraining:
    ...
    def __init__(self, templates, streams, num_individuals=1, use_encoding=False):
        ...
        if not use_encoding:
            ...
            wlcss_dll = ctypes.CDLL(os.path.abspath("libs/cuda/lib_wlcss_cuda_params_training_optimized_2d_enc.so"))
        elif use_encoding == '3d':
            wlcss_dll = ctypes.CDLL(os.path.abspath("libs/cuda/lib_wlcss_cuda_params_training_optimized_3d_enc.so"))
...
class WLCSSCudaTemplatesTraining:
    ...
    def __init__(self, streams, params, t_len, num_individuals, use_encoding):
        ...
        if not use_encoding:
            ...
            wlcss_dll = ctypes.CDLL(os.path.abspath("libs/cuda/lib_wlcss_cuda_templates_training_optimized_2d_enc.so"))
        elif use_encoding == '3d':
            wlcss_dll = ctypes.CDLL(os.path.abspath("libs/cuda/lib_wlcss_cuda_templates_training_optimized_3d_enc.so"))
        self._wlcss_init = wlcss_dll.wlcss_cuda_init
        self._wlcss_init.argtype = [POINTER(c_int32), POINTER(c_int32), POINTER(c_int32), POINTER(c_int32),
                                    POINTER(c_int32), POINTER(c_int32), POINTER(c_int32), POINTER(c_int32),
                                    c_int, c_int, c_int, c_int, c_int, c_int]
